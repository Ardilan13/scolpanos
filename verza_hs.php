                ...
                <div class="container container-fs">
                    <div class="row">
                        <div class="default-secondary-bg-color col-md-12 inset brd-bottom clearfix">
                            <h1 class="primary-color">Verzamelstaten V2:</h1>
        ...
        if (klas != 'NONE') {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    window.open("dev_tests\\export_verza2.php?rapport_klassen_lijst=" + $("#rapport_klassen_lijst option:selected").val() + "&rapport=" + $("#cijfers_rapporten_lijst option:selected").val());
