            ...
            <div class="primary-bg-color brd-full">
              <div class="box">
                ...
                <div class="box-content full-inset sixth-bg-color">
                  <div id="table_notifications" class="dataRetrieverOnLoad" data-ajax-href="ajax/getnotifications_tabel.php"></div>
                  <div class="table-responsive">
                    <div id="table_notifications_result_"></div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="sixth-bg-color box content full-inset">
                  <form class="form-horizontal align-left" role="form" name="form-add-notifications" id="form-notifications">
                        ...
                        <div id="lblto" class="form-group">
                          ...
                          <div class="col-md-8">
                            <select id="cboTo" name="cbo_to" class="form-control">
                              ...
                              <option value="all_u">All staff</option>
                              <option value="all_s_all_u">All staff & Students</option>
                    ...
                    <div id="lbl_txtMessage" class="form-group">
                      ...
                      <div id="text_message"  class="col-md-12">
                        <textarea id="message" name="message" rows="15" cols="50" maxlength="2000"></textarea>
                      </div>
...
$( document ).ready(function() {
  $('#table_notifications_result_').css({"overflow-y": "auto", "height": "320px"})
...
$('#btn-add-notificaction').click(function()
{
  ...
  function (data)
  {
    if(data != "1")
    {
      ...
      $('#message').val('');
      $.get("ajax/getnotifications_tabel.php", function(htmlresult) {
