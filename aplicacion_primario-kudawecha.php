...
<head>
    <title>Scol Primario Kudawecha</title>
    ...
    <div class="container">
        <div class="form-bg"'>
            ...
            <form action="ajax/get_aplicacionform_excel.php" method="POST">
                ...
                <input name="admin" type="text" value="9" hidden>
