			...
			<div class="info">
				<div class="form_group">
					<?php if ($row["identiteitsbewijs"] != null && $row["identiteitsbewijs"] != "") { ?>
						<label>Identiteitsbewijs:</label><a href="ajax/<?php echo $row["identiteitsbewijs"]; ?>" download="identiteitsbewijs_<?php echo $row["voornamen"]; ?>_<?php echo $row["naam"]; ?>_<?php echo $id; ?>">Download.</a>
					<?php } else { ?>
						<label>Identiteitsbewijs: <b>Empty.</b></label>
					<?php } ?>
				</div>
				<!-- <div class="form_group">
				...
				<div id="bishita" class="form_group">
					<h1 style="margin: 0;">CB2</h1>
				</div>
				<div class="form_group">
					<?php if ($row["verklaring"] != null && $row["verklaring"] != "") { ?>
						<label>Uploaden rapport 1 en 2 van CB1 of Uploaden rapport 1 en 2 van CB 2:</label><a href="ajax/<?php echo $row["verklaring"]; ?>" download="cb1_<?php echo $row["voornamen"]; ?>_<?php echo $row["naam"]; ?>_<?php echo $id; ?>">Download.</a>
					<?php } else { ?>
						<label>Uploaden rapport 1 en 2 van CB1 of Uploaden rapport 1 en 2 van CB 2: <b>Empty.</b></label>
					<?php } ?>
				</div>

				<div id="bishita" class="form_group">
					<h1 style="margin: 0;">HAVO 3</h1>
				</div>
				<!-- <div class="form_group">
				...
				<div class="form_group">
					<?php if ($row["klas5"] != null && $row["klas5"] != "") { ?>
						<label>Uploaden rapport 1 en 2 van havo 2 of Uploaden rapport 1 en 2 van havo 3:</label><a href="ajax/<?php echo $row["klas5"]; ?>" download="schooladvies<?php echo $row["voornamen"]; ?>_<?php echo $row["naam"]; ?>_<?php echo $id; ?>">Download.</a>
					<?php } else { ?>
						<label>Uploaden rapport 1 en 2 van havo 2 of Uploaden rapport 1 en 2 van havo 3: <b>Empty.</b></label>
					<?php } ?>
				</div>

				<div id="bishita" class="form_group">
					<h1 style="margin: 0;">VWO 3</h1>
				</div>
				<div class="form_group">
					<?php if ($row["schooladvies"] != null && $row["schooladvies"] != "") { ?>
						<label>Uploaden rapport 1 en 2 van cb 2 met schooladvies of Uploaden rapport 1 en 2 van vwo 3:</label><a href="ajax/<?php echo $row["schooladvies"]; ?>" download="Rapport_H3<?php echo $row["voornamen"]; ?>_<?php echo $row["naam"]; ?>_<?php echo $id; ?>">Download.</a>
					<?php } else { ?>
						<label>Uploaden rapport 1 en 2 van cb 2 met schooladvies of Uploaden rapport 1 en 2 van vwo 3: <b>Empty.</b></label>
					<?php } ?>
				</div>

				<div id="bishita" class="form_group">
					<h1 style="margin: 0;">HAVO 4</h1>
				</div>
				<div class="form_group">
					<?php if ($row["profielh4"] != null && $row["profielh4"] != "") { ?>
						<label>Download profielkeuze:</label><a href="ajax/<?php echo $row["profielh4"]; ?>" download="Profiel_H3_<?php echo $row["voornamen"]; ?>_<?php echo $row["naam"]; ?>_<?php echo $id; ?>">Download.</a>
					<?php } else { ?>
						<label>Download profielkeuze: <b>Empty.</b></label>
					<?php } ?>
				</div>
				<div class="form_group">
					<?php if ($row["klas6"] != null && $row["klas6"] != "") { ?>
						<label>Uploaden rapport 1 en 2 van havo 3 of Uploaden rapport 1 en 2 van havo 4:</label><a href="ajax/<?php echo $row["klas6"]; ?>" download="Rapport_H4_<?php echo $row["voornamen"]; ?>_<?php echo $row["naam"]; ?>_<?php echo $id; ?>">Download.</a>
					<?php } else { ?>
						<label>Uploaden rapport 1 en 2 van havo 3 of Uploaden rapport 1 en 2 van havo 4: <b>Empty.</b></label>
					<?php } ?>
				</div>
