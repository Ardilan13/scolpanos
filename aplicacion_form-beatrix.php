...
<head>
	<title>Aplicacion Form Beatrix</title>
...
<main>
    <div class="container">
		<div class="form-bg"'>
            ...
            <h1>Reina Beatrix School</h1>
            <h2>Aplicacion Scol 2022-2023:</h2>
            <?php $DBCreds = new DBCreds();
$mysqli = new mysqli($DBCreds->DBAddress, $DBCreds->DBUser, $DBCreds->DBPass, $DBCreds->DBSchema, $DBCreds->DBPort);
$mysqli->set_charset('utf8');
$query = "SELECT ID,status,fam,nomber,sexo,f_nacemento,districto,ruman,collega,number_mayor1,number_mayor2,prome_preferencia,segundo_preferencia FROM aplicacion_forms WHERE (prome_preferencia = 4 OR segundo_preferencia = 4) ORDER BY ID ASC";
