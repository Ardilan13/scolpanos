<div class="modal fade" id="modallogboek" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header primary-bg-color">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="modal-label">Afspraken van gerbuiker</h4>
      </div>
      <div class="modal-body sixth-bg-color">
        <form id="opslaan-leerling-logboek" class="form-horizontal align-left" role="form">
          <fieldset>
