                  ...
                  while ($stmt->fetch()) {
                    ...
                    if (strpos($complete_name, 'CKV')) {
                      ...
                      if (!$is_ckv) {
                        ...
                        if ($rapnummer == 1) {
                          $table .= "<td " . ((float)$avg_rap1 >= 1 && (float)$avg_rap1 < 5.5  && (float)$avg_rap1 ? "class=\"bg-danger\"" : "") . ">" . ((float)$avg_rap1 > 0.0 && $avg_rap1 != null  && $avg_rap1 != "" ? round($avg_rap1, 1) : "") . "</td>";
                          $table .= "<td></td>";
                          $table .= "<td></td>";
                        }
                        ...
                        if ($rapnummer == 2) {
                          $table .= "<td " . ((float)$avg_rap1 >= 1 && (float)$avg_rap1 < 5.5  && (float)$avg_rap1 ? "class=\"bg-danger\"" : "") . ">" . ((float)$avg_rap1 > 0.0 && $avg_rap1 != null  && $avg_rap1 != "" ? round($avg_rap1, 1) : "") . "</td>";
                          $table .= "<td " . ((float)$avg_rap2 >= 1 && (float)$avg_rap2 < 5.5  && (float)$avg_rap2 ? "class=\"bg-danger\"" : "") . ">" . ((float)$avg_rap2 > 0.0 && $avg_rap2 != null  && $avg_rap2 != "" ? round($avg_rap2, 1) : "") . "</td>";
                          $table .= "<td></td>";
                        }
                        if ($rapnummer == 3) {
                          $table .= "<td " . ((float)$avg_rap1 >= 1 && (float)$avg_rap1 < 5.5  && (float)$avg_rap1 ? "class=\"bg-danger\"" : "") . ">" . ((float)$avg_rap1 > 0.0 && $avg_rap1 != null  && $avg_rap1 != "" ? round($avg_rap1, 1) : "") . "</td>";
                          $table .= "<td " . ((float)$avg_rap2 >= 1 && (float)$avg_rap2 < 5.5  && (float)$avg_rap2 ? "class=\"bg-danger\"" : "") . ">" . ((float)$avg_rap2 > 0.0 && $avg_rap2 != null  && $avg_rap2 != "" ? round($avg_rap2, 1) : "") . "</td>";
                          $table .= "<td " . ((float)$avg_rap3 >= 1 && (float)$avg_rap3 < 5.5  && (float)$avg_rap3 ? "class=\"bg-danger\"" : "") . ">" . ((float)$avg_rap3 > 0.0 && $avg_rap3 != null  && $avg_rap3 != "" ? round($avg_rap3, 1) : "") . "</td>";
                        }

                        $table .= "<td class='" . $color . "' " . ((float)$final_avg_CKV >= 1 && (float)$final_avg_CKV < 5.5  && (float)$final_avg_CKV ? "class=\"bg-danger\"" : "") . ">" . ((float)$final_avg_CKV > 0.0 && $final_avg_CKV != null  && $final_avg_CKV != "" ? ($final_avg_CKV >= 5.5 && $final_avg_CKV <= 6 ? 6 : round($final_avg_CKV)) : "") . "</td>";
                        $is_ckv = true;
                      }
                      ...
                      if ($rapnummer == 1) {
                        $table .= "<td " . $blue . ((float)$gemmindele1 >= 0 && (float)$gemmindele1 < 5.5  && (float)$gemmindele1 ? "class=\"bg-danger\"" : "") . ">" . ((float)$gemmindele1 > 0.0 && $gemmindele1 != null  && $gemmindele1 != "" || $gemmindele1 == "V" ? $gemmindele1 : "") . "</td>";
                        $table .= "<td></td>";
                        $table .= "<td></td>";
                        if ($level_klas == 4) {
