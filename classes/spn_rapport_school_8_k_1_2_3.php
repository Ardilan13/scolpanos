...
class spn_rapport_school_8_k_1_2_3
{
	...
	function _openexceltemplate($klas_in)
	{
		...
		$this->rapport_modified = $this->rapport_reader->load("../templates/8_conrado_klas_1_2_3.xlsm");
	}
	...
	function _writerapportdata_cijfers($schoolid,$schooljaar,$klas_in,$rap_in)
	{
							...
							$select->bind_result(
								...
								{									/* initialize last student id if whilecounter == 0 */
									...
									if($_currentstudent != $_laststudent)
									{
										...
										$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("AQ" . (string)$_current_student_start_row, $opmerking_result);
		...
		function _writerapportdata_houding($schoolid,$schooljaar,$klas_in,$rap_in)
		{
									...
									while($select->fetch() && $_cijfers_count)
									{
										...
										while ($cont_houdin < 19)
											...
											switch ($cont_houdin){
												case 1:
												$_h1="";
												$colhouding = "L". (string)$_current_student_start_row;
												...
												case 18:
												$_h18="";
												$colhouding = "D". (string)$_current_student_start_row;
			...
			function _writeeapportdata_verzuim($schoolid,$schooljaar,$klas_in,$rap_in)
			{
				...
				$cont_verzuim = 1;
				$cont_verzuim_laat = "AO";
				$cont_verzuim_verzm = "AP";
