...
class spn_rapport_school_11
{
	...
	function _openexceltemplate()
	{
		...
		$this->rapport_modified = $this->rapport_reader->load("../templates/11_Hilario.xlsm");
	...
	function _exportexcelfile($exporttobrowser = true)
	{
		...
		if($exporttobrowser)
		{
			...
			header('Content-Disposition: attachment; filename="hilario_angela_rapport.xlsm"');
			/* add headers for output to browser */
		}
