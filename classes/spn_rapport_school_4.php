...
class spn_rapport_school_4
{
	...
	function _openexceltemplate($klas_in)
	{
		...
		if (strpos($klas_in, '3') !== false){
			 $this->rapport_modified = $this->rapport_reader->load("../templates/4_kudawecha_klass3.xlsm");
		}
		else {
				$this->rapport_modified = $this->rapport_reader->load("../templates/4_kudawecha.xlsm");
		}
