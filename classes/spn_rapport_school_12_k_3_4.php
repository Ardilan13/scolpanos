...
class spn_rapport_school_12_k_3_4
{
	...
	function _openexceltemplate()
	{
		...
		$this->rapport_modified = $this->rapport_reader->load("../templates/12_ceque_rapport_file_k3-4.xlsm");
	...
	function _exportexcelfile($exporttobrowser = true)
	{
		...
		if($exporttobrowser)
		{
			...
			header('Content-Disposition: attachment; filename="12_ceque_rapport_file.xlsx"');
			/* add headers for output to browser */
		}
