        ...
        if ($stmt = $mysqli->prepare("CALL " . $this->sp_create_setting . " (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)")) {
          ...
          if ($stmt->bind_param(
            ...
            if ($stmt->execute()) {
              ...
              $result = 1;
              $_SESSION["SchoolJaar"] = $setting_school_jaar;
              $stmt->close();
              $mysqli->close();
            } else {
              $result = 0;
            ...
            if ($select->execute()) {
              ...
              if ($select->num_rows > 0) {
                ...
                while ($select->fetch()) {
                  ...
                  $_setting_begin_rap_1 = date("d-m-Y", strtotime($setting_begin_rap_1));
                  $_setting_end_rap_1 = date("d-m-Y", strtotime($setting_end_rap_1));
                  $_setting_begin_rap_2 = date("d-m-Y", strtotime($setting_begin_rap_2));
                  $_setting_end_rap_2 = date("d-m-Y", strtotime($setting_end_rap_2));
                  $_setting_begin_rap_3 = date("d-m-Y", strtotime($setting_begin_rap_3));
                  $_setting_end_rap_3 = date("d-m-Y", strtotime($setting_end_rap_3));
                  ...
                  $htmlcontrol .= "<td>" . htmlentities($_setting_begin_rap_1) . "</td>";
                  $htmlcontrol .= "<td>" . htmlentities($_setting_end_rap_1) . "</td>";
                  $htmlcontrol .= "<td>" . (htmlentities($setting_rapnumber_2) ? "Active" : "Inactive") . "</td>";
                  $htmlcontrol .= "<td>" . htmlentities($_setting_begin_rap_2) . "</td>";
                  $htmlcontrol .= "<td>" . htmlentities($_setting_end_rap_2) . "</td>";
            ...
            if ($select->execute()) {
              ...
              if ($select->num_rows > 0) {
                while ($select->fetch()) {
                  ...
                  $this->_setting_school_name = $setting_school_name;
                  ...
                  $this->_cijfer1 = $cijfer1;
                  $this->_cijfer2 = $cijfer2;
                  $this->_cijfer3 = $cijfer3;
                }
              } else {
                $this->_setting_id = 0;
