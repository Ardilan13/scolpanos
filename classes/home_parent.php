      ...
      <?php if($_SESSION['SchoolID']==4) : ?>
        ...
        <div class="row">
          <div class="form-group col-md-12 full-inset">
            <a href="templates/Schoolgids 2020-2021.pdf" target="_blank" class="btn btn-info btn-m-w pull-right mrg-left" id="btn_add_contact">schoolgids 2020-2021</a>
    ...
    <div class="jumbotron white">
      <div class="row">
        <form class="form-inline col-md-12" name="frm_home_parent" id="frm_leerling_schooljaar">
          ...
          <div class="input-group col-md-1">
            <input type="radio"class="form-group" name="_2021-2022" id="_2021-2022" checked="checked"/>
            <input type="hidden" name="2021-2022" id="2021-2022" value="1"/>
          </div>
        </form>
      </div>
      <div class="row">
...
<script type="text/javascript" src="assets/js/parent.js?05"></script>
