...
class spn_rapport_school_7
{
	...
	function _openexceltemplate()
	{
		...
		$this->rapport_modified = $this->rapport_reader->load("../templates/7_Prinses_Amalia.xlsm");
	...
	function _exportexcelfile($exporttobrowser = true)
	{
		...
		if($exporttobrowser)
		{
			...
			header('Content-Disposition: attachment; filename="Prinses_Amalia_rapport.xlsm"');
			/* add headers for output to browser */
		}
