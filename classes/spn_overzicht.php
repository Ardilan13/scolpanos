...
class spn_overzicht
{
	...
	function _exportexcelfile($klas_in,$exporttobrowser = true)
	{
		...
		if($exporttobrowser)
		{
			...
			header('Content-Disposition: attachment; filename="kudawecha_rapport.xlsm"');
			/* add headers for output to browser */
		}
	...
	function _writer_overzicht_data($schoolid,$schooljaar,$klas_in)
	{
		...
		$_default_excel_klas = "J2";
		$_default_excel_schooljaar = "H2";

		$_default_excel_schoolname = "A1";
		$_default_excel_letter_class = "K2";
		$_idiom="";
			...
			if($select=$mysqli->prepare($sql_query))
			{
				if($select->bind_param("is",$schoolid, $klas_in))
				{
					if($select->execute())
					{
						...
						{
							$result=1;
							$select->bind_result($studentid_out, $idnumber, $studentnumber, $firstname, $lastname,
							$sex,
							$studentnumber,
							$address,
							$ne,$en,$sp,$pa,$voertaalanders,
							...
							while($select->fetch())
							{
								...
								if($_while_counter == 0)
								{
									...
									$_default_excel_klas = "J2";
									$_default_excel_schooljaar = "H2";
									$_default_excel_klas2 = "T2";
									$_default_excel_schooljaar2 = "Q2";
									$_default_excel_schoolname = "A1";
									$_default_excel_schoolname2 = "M1";
									$_default_excel_letter_class = "K2";
									...
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue($_default_excel_schoolname2, $_SESSION["schoolname"]);
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue($_default_excel_schooljaar2, $_SESSION["SchoolJaar"]);
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue($_default_excel_klas2,$klas_in);
									...
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("B". (string)$_current_student_start_row, $studentnumber);
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("E". (string)$_current_student_start_row, $lastname);
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("F" . (string)$_current_student_start_row, $sex );
									if ($_SESSION["SchoolID"]== 4){
										...
										$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("G" . (string)$_current_student_start_row, $idnumber);
									}
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("H" . (string)$_current_student_start_row, $address);
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("I" . (string)$_current_student_start_row, $voertaalanders);
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("J" . (string)$_current_student_start_row, $geb);
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("K" . (string)$_current_student_start_row, $dob);
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("L" . (string)$_current_student_start_row, $nationaliteit);
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("Q" . (string)$_current_student_start_row, $father);
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("M" . (string)$_current_student_start_row, $mother);
									...
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("R" . (string)$_current_student_start_row, $mobiel_father);
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("S" . (string)$_current_student_start_row, $huis_father);
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("T" . (string)$_current_student_start_row, $work_father);
									$this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("U" . (string)$_current_student_start_row, $created);
