...
foreach($array_leerling as $item) {
  ...
  $page_html .="</br>";
  $page_html .="</br>";
  $page_html .="<img  src='".appconfig::GetBaseURL()."/assets/img/ceque_logo.png' class='mx-auto d-block'>";
  ...
  $page_html .="<h5 class='card-title text-center'>C E Q U E&nbsp&nbsp&nbsp&nbsp&nbspC O L L E G E</h5>";
