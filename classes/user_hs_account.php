								...
								<div class="sixth-bg-color box content full-inset">
									<form class="form-horizontal align-left" role="form" name="frm_user_hs_account" id="frm_user_hs_account">
										<div class="alert alert-danger hidden">
											<p>
												<i class="fa fa-warning"></i> Er zijn lege velden die ingevuld moet worden!</p>
										</div>
										<div class="alert alert-error hidden">
											<p>
												<i class="fa fa-warning"></i> Please check the user form</p>
										</div>
										<div class="alert alert-error hidden" id='error_removing_user'>
											<p>
												<i class="fa fa-warning"></i> Error removing user</p>
										</div>
										<div class="alert alert-error-password hidden">
											<p>
												<i class="fa fa-warning"></i> The password and password confirmation do not match</p>
										</div>
										<div class="alert alert-info hidden">
											<p>
												<i class="fa fa-check"></i> The new User has been register!</p>
										</div>
										<div class="alert alert-info hidden" id="updated_suscessfully">
											<p>
												<i class="fa fa-check"></i> The User has been Updated</p>
										</div>
										<div class="alert alert-info hidden" id="created_suscessfully">
											<p>
												<i class="fa fa-check"></i> The User Has Been Created</p>
										</div>
										<div class="alert alert-info hidden" id="deleted_suscessfully">
											<p>
												<i class="fa fa-check"></i> The User Has Been Deleted</p>
										</div>
										<fieldset>
											...
											<div class="form-group full-inset">
												...
												<button type="reset" class="btn btn-danger btn-m-w pull-right mrg-left hidden" id="btn_delete_user_hs_account">DELETE</button>
											</div>
										</fieldset>
									</form>
								</div>
...
<script>
	...
	$frm_user_hs_account = $('#frm_user_hs_account'),
		...
		$("#btn_create_user_hs_account").click(function (e) {       /* prevent refresh */
			e.preventDefault();
	...
	$("#btn_delete_user_hs_account").on("click", function (e) {
		...
		// DELETE a TEST
		var r = confirm("Delete user_hs_account?");
		if (r) {
			/* begin post */
			$.ajax({
