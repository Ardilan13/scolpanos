...
class spn_rapport_school_17
{
    ...
    function _openexceltemplate()
    {
        ...
        $this->rapport_modified = $this->rapport_reader->load("../templates/17_monplaisir_rapport_file_2.xlsm");
    ...
    function _exportexcelfile($exporttobrowser = true)
    {
        ...
        if ($exporttobrowser) {
            ...
            header('Content-Disposition: attachment; filename="MonPlaisir_rapport_file_h2.xlsm"');
            /* add headers for output to browser */
        }
 ...
 */                                /* Write Student Name */
                            ...
                            if ($rap_in == 1) {
                                ...
                                if ($vakid_out == 552463 || $vakid_out == 552477) {
                            ...
                            if ($rap_in == 3) {
                                ...
                                if ($vakid_out == 552463 || $vakid_out == 552477) {
                                    ...
                                    $this->rapport_modified->setActiveSheetIndex($this->activesheet_index)->setCellValue("CW" . (string)$_current_student_start_row, $gemiddelde_out);
                                }
                                if ($_while_counter > 0) {
