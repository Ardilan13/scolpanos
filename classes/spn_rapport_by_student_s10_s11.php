...
class spn_rapport_by_student_s10_s11
{
	...
	function createrapport($schoolid,$schooljaar,$studentid, $generate_all_rapporten){
		...
		$objPHPExcel = PHPExcel_IOFactory::load("../templates/Witte_kaart_2018_s10_s11.xlsx");
		...
		header('Content-Disposition: attachment;filename="Witte_kaart.xlsx"');
								...
								while($select->fetch())
								{
									...
									if($current_schooljaar != $last_schooljaar)
									{
										...
										if ( $c==1 ){
											...
											$this->write_verzuim_data($objPHPExcel,$id_student, $schooljaar, "E");
											$this->write_houding_data($objPHPExcel,$id_student, $schooljaar, "E");
											$this->write_avi_data($objPHPExcel,$id_student,$schooljaar,"E");
										...
										if ( $c==2 ){
											...
											$this->write_verzuim_data($objPHPExcel,$id_student, $schooljaar, "H");
											$this->write_houding_data($objPHPExcel,$id_student, $schooljaar, "H");
											$this->write_avi_data($objPHPExcel,$id_student, $schooljaar,"H");
										...
										if ( $c==3 ){
											...
											$_default_klas = "K5";
											$_default_docent = "K6";
											$this->write_verzuim_data($objPHPExcel,$id_student, $schooljaar, "K");
											$this->write_houding_data($objPHPExcel,$id_student, $schooljaar, "H");
											$this->write_avi_data($objPHPExcel,$id_student, $schooljaar, "K");
										...
										if ( $c==5 ){
											...
											$_default_klas = "Q5";
											$_default_docent = "Q6";
											$this->write_verzuim_data($objPHPExcel,$id_student, $schooljaar, "Q");
											$this->write_houding_data($objPHPExcel,$id_student, $schooljaar, "H");
											$this->write_avi_data($objPHPExcel,$id_student, $schooljaar,"Q");
										...
										if ( $c==6 ){
											...
											$_default_klas = "T5";
											$_default_docent = "T6";
											$this->write_verzuim_data($objPHPExcel,$id_student, $schooljaar, "T");
											$this->write_houding_data($objPHPExcel,$id_student, $schooljaar, "T");
											$this->write_avi_data($objPHPExcel,$id_student, $schooljaar,"T");
										...
										if ( $c==7 ){
											...
											$_default_klas = "W5";
											$_default_docent = "W6";
											$this->write_verzuim_data($objPHPExcel,$id_student, $schooljaar, "W");
											$this->write_houding_data($objPHPExcel,$id_student, $schooljaar, "W");
											$this->write_avi_data($objPHPExcel,$id_student, $schooljaar,"W");
				...
				if($select->execute())
				{
					...
					if($select->num_rows > 0)
					{
						...
						while($select->fetch())
						{
							...
							$objPHPExcel->setActiveSheetIndex(0)->setCellValue($colum_schooljaar."55", $telaat );
							$objPHPExcel->setActiveSheetIndex(0)->setCellValue($colum_schooljaar."56", $absentie );
						}
					}
				}
			}
					...
					if($select->execute())
					{
						...
						if($select->num_rows > 0)
						{
							...
							while($select->fetch())
							{
								...
								$objPHPExcel->setActiveSheetIndex(0)->setCellValue($colum_rapport.$Leerk,$_h1);
								$objPHPExcel->setActiveSheetIndex(0)->setCellValue($colum_rapport.$Leerl,$_h2);
								$objPHPExcel->setActiveSheetIndex(0)->setCellValue($colum_rapport.$Zelfvert,$_h3);

								$objPHPExcel->setActiveSheetIndex(0)->setCellValue($colum_rapport.$Nauwkeurigheid,$_h4);
								$objPHPExcel->setActiveSheetIndex(0)->setCellValue($colum_rapport.$Doorzettingsvermogen,$_h5);
								$objPHPExcel->setActiveSheetIndex(0)->setCellValue($colum_rapport.$Zelfstandigheid,$_h6);
								$objPHPExcel->setActiveSheetIndex(0)->setCellValue($colum_rapport.$Werktempo,$_h7);
								$objPHPExcel->setActiveSheetIndex(0)->setCellValue($colum_rapport.$Werkverzorging,$_h8);
								$objPHPExcel->setActiveSheetIndex(0)->setCellValue($colum_rapport.$Concentratie,$_h9);
