...
<main>
    <div class="container">
        <div class="form-bg"'>
            ...
            $query = "SELECT ID,status,naam,voornamen,roepnaam,sexo,geboorteland,f_nacemento,klas5,klas6,profielh3,profielh4,profielm4,mavo4,districto,profiel,afleverende FROM aplicacion_college WHERE type = 2 ORDER BY ID ASC";
            ...
            <table class="table table-striped table-bordered">
                ...
                <?php while ($row = mysqli_fetch_assoc($resultado)) { ?>
                    <tr>
                        ...
                        <th><?php if ($row["profiel"] == 1) {
                                echo 'NW01';
                            } else if ($row["profiel"] == 2) {
                                echo 'NW02';
                            } else if ($row["profiel"] == 3) {
                                echo 'NW03';
                            } else if ($row["profiel"] == 4) {
                                echo 'MM01';
                            } else if ($row["profiel"] == 5) {
                                echo 'MM02';
                            } else if ($row["profiel"] == 6) {
                                echo 'HU01';
                            } else if ($row["profiel"] == 7) {
                                echo 'HU02';
                            } ?></th>
                        <th class="datum"><?php if ($row["districto"] == 1) {
                            ...
                            <th class="sex">
                                <form action="college-update-havo4.php" method="POST">
