...
<head>
    <title>Colegio Conrado Coronel Kleuter</title>
...
<main>
    <div class="container">
        <div class="form-bg"'>
            ...
            <h1>Colegio Conrado Coronel Kleuter</h1>
            <h2>Aplicacion Scol 2023-2024:</h2>
            <?php $DBCreds = new DBCreds();
            $mysqli = new mysqli($DBCreds->DBAddress, $DBCreds->DBUser, $DBCreds->DBPass, $DBCreds->DBSchema, $DBCreds->DBPort);
            $mysqli->set_charset('utf8');
            $query = "SELECT ID,status,fam,nomber,sexo,f_nacemento,districto,ruman,collega,number_mayor1,number_mayor2,prome_preferencia,segundo_preferencia FROM aplicacion_forms WHERE (prome_preferencia=12 OR segundo_preferencia=12) ORDER BY ID ASC";
            ...
            <form action="ajax/get_aplicacionform_excel.php" method="POST">
                ...
                <input name="admin" type="text" value="12" hidden>
