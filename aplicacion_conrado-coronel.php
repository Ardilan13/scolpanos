...
<head>
    <title>Colegio Conrado Coronel</title>
...
<main>
    <div class="container">
        <div class="form-bg"'>
            ...
            $query = "SELECT ID,status,fam,nomber,sexo,f_nacemento,districto,ruman,collega,number_mayor1,number_mayor2,prome_preferencia,segundo_preferencia FROM aplicacion_forms WHERE (prome_preferencia=11 OR segundo_preferencia=11) ORDER BY ID ASC";
            ...
            <table class="table table-striped table-bordered">
                ...
                <?php while ($row = mysqli_fetch_assoc($resultado)) { ?>
                    <tr>
                        ...
                        <th><?php if($row["prome_preferencia"]==11){ echo '1';} else{ echo '2';} ?></th>
            ...
            <form action="ajax/get_aplicacionform_excel.php" method="POST">
                ...
                <input name="admin" type="text" value="11" hidden>
