...
<main>
    <div class="container">
        <div class="form-bg"'>
            ...
            $query = "SELECT ID,status,naam,voornamen,roepnaam,sexo,geboorteland,f_nacemento,adres,districto,afleverende FROM aplicacion_college WHERE type = 0 ORDER BY ID ASC";
            ...
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="datum">Geboorteland</th>
                ...
                <?php while ($row = mysqli_fetch_assoc($resultado)) { ?>
                    <tr>
                        ...
                        <th class="sex">
                        <form action="aplicacion_college-update.php" method="POST">
