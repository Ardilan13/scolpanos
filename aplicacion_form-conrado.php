...
<head>
	<title>Aplicacion Form Conrado</title>
...
<main>
    <div class="container">
		<div class="form-bg"'>
            ...
            <h1>Colegio Conrado Coronel</h1>
            <h2>Aplicacion Scol 2022-2023:</h2>
            <?php $DBCreds = new DBCreds();
$mysqli = new mysqli($DBCreds->DBAddress, $DBCreds->DBUser, $DBCreds->DBPass, $DBCreds->DBSchema, $DBCreds->DBPort);
$mysqli->set_charset('utf8');
$query = "SELECT ID,status,fam,nomber,sexo,f_nacemento,districto,ruman,collega,number_mayor1,number_mayor2,prome_preferencia,segundo_preferencia FROM aplicacion_forms WHERE (prome_preferencia = 1 OR segundo_preferencia = 1) ORDER BY ID ASC";
            ...
            <table class="table table-striped table-bordered">
                ...
                <?php while ($row = mysqli_fetch_assoc($resultado)) {?>
                    <tr>
                        ...
                        <th><?php if($row["prome_preferencia"]==1){ echo '1';} else{ echo '2';} ?></th>
                        <form action="aplicacion_form-update.php" method="POST">
                        <input name="id" hidden type="text" hidden value="<?php echo $row["ID"]; ?>">
                        <input name="scol" type="text" hidden value="1">
