	...
	<main id="main" role="main" class="login">
		<div class="container">
			...
			<form action="ajax/college_update.php" method="POST" id="formulario">
				<h1>Aanmeldingsformulier Update Schooljaar 2023 – 2024</h1>
                <h3>Mon Plaisir College HAVO-VWO</h3>
                <h3>CB2/H3/V3/H4/H5</h3>
				<h2>Personalia:</h2>
			<div class="info">
			...
			<div class="info">
				...
				<div class="form_group">
					<?php if ($row["klas5"] != null && $row["klas5"] != "") { ?>
						<label>Rapport klas 5:</label><a href="ajax/<?php echo $row["klas5"]; ?>" download="klas5_<?php echo $row["voornamen"]; ?>_<?php echo $row["naam"]; ?>_<?php echo $id; ?>">Download.</a>
					<?php } else { ?>
						<label>Rapport klas 5: <b>Empty.</b></label>
					<?php } ?>
				</div>
				<div class="form_group">
					<?php if ($row["klas6"] != null && $row["klas6"] != "") { ?>
						<label>Rapport klas 6 P 1 en 2:</label><a href="ajax/<?php echo $row["klas6"]; ?>" download="klas6_P1-2_<?php echo $row["voornamen"]; ?>_<?php echo $row["naam"]; ?>_<?php echo $id; ?>">Download.</a>
					<?php } else { ?>
						<label>Rapport klas 6 P 1 en 2: <b>Empty.</b></label>
					<?php } ?>
				</div>
			</div>
			...
			<div class="info">
				...
				<div class="form_group" id="bishita">
					<input name="afleverende" type="text" value="<?php echo $row["afleverende"]; ?>" class="input-text" placeholder=" " required><label class="form_label">Afleverende school/van welke school komt de leerling:</label>
				</div>
			</div>
