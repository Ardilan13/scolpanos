...
// {
	...
	print  $m->update_mdc($_POST["id_mdc"],$_POST["mdc_school_year"], $u->converttomysqldate($_POST["mdc_date"]), $_POST["mdc_reason"], $_POST["mdc_class_value"],$_POST["mdc_observation"],$_POST["mdc_pending_selected"],appconfig::GetDummy());
