...
// {
	...
	print  $m->create_social_work($_POST["social_work_school_year"],	$u->converttomysqldate($_POST["social_work_date"]),$_POST["social_work_reason"],$_POST["social_work_class_hidden"],	$_POST["social_work_observation"],$_POST["social_work_pending_selected"],	$_POST["id_student"],appconfig::GetDummy());
