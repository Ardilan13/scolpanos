...
$result = "";
$result = $a->get_verzuim_resume($u->converttomysqldatetime($_GET["start_date"]), $u->converttomysqldatetime($_GET["end_date"]), $_GET["rapport_klassen_lijst"],$_SESSION["SchoolID"],$_SESSION["SchoolJaar"],$rappor_te_laat, $rappor_absent, $rappor_inhalen, $rappor_uitsturen, $rappor_huiswerk ,appconfig::GetDummy());
