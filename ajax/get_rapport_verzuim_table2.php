...
print $a->list_rapport_verzuim_table2($u->converttomysqldatetime($_POST["start_date"]), $u->converttomysqldatetime($_POST["end_date"]), $_POST["rapport_klassen_lijst"],$_SESSION["SchoolID"],$_SESSION["SchoolJaar"],$rappor_te_laat, $rappor_absent, $rappor_inhalen, $rappor_uitsturen, $rappor_huiswerk ,appconfig::GetDummy());
