...
<script type="text/javascript">
	$(function() {
		...
		$('#dataRequest-setting-detail tr').click(function() {
			...
			($(this).find("td").eq(11).attr('c1') == '1' ? $('#setting_c1').prop("checked", true) : $('#setting_c1').prop("checked", false));
			($(this).find("td").eq(11).attr('c1') == '1' ? $("#setting_c1_val").val(1) : $("#setting_c1_val").val(0));

			($(this).find("td").eq(11).attr('c2') == '1' ? $('#setting_c2').prop("checked", true) : $('#setting_c2').prop("checked", false));
			($(this).find("td").eq(11).attr('c2') == '1' ? $("#setting_c2_val").val(1) : $("#setting_c2_val").val(0));

			($(this).find("td").eq(11).attr('c3') == '1' ? $('#setting_c3').prop("checked", true) : $('#setting_c3').prop("checked", false));
			($(this).find("td").eq(11).attr('c3') == '1' ? $("#setting_c3_val").val(1) : $("#setting_c3_val").val(0));

			console.log($(this).find("td").eq(11).attr('c1'))
