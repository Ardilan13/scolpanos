...
if (isset($_SESSION["UserRights"]) && isset($_SESSION["SchoolID"])) {
	...
	} else if ($_SESSION["UserRights"] == "BEHEER" || $_SESSION["UserRights"] == "ADMINISTRATIE" || $_SESSION["UserRights"] == "ONDERSTEUNING"  || $_SESSION["UserRights"] == "ASSISTENT" || $_SESSION["UserRights"] == "TEACHER") {
		$s = new spn_controls();
