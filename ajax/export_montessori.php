            ...
            <section style="margin-bottom: 700px;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table border="0">
                                    <tr>
                                        <td width="310px">
                                            <img src="<?php print appconfig::GetBaseURL(); ?>/assets/img/angela.png"
                                                width="100px" height="100px" class="block-center img-responsive"
                                                alt="Scol pa Nos">
                                            <h5 class="col-md-12 secondary-color"><?php echo $_SESSION["schoolname"] ?>
                                            </h5>
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        ?>
                    <div
                        style='display:flex; flex-direction: row; margin: 40px 0; justify-content: space-between; width: 100%; align-items: end; min-height: 100px;'>
                        <h5 style='margin-bottom: 0 !important;display: inline;'>Naam schoolboofd:
                            <?php echo $cabesante; ?></h5>
                    ...
                    <div
                        style='display:flex; flex-direction: row; justify-content: space-between; width: 100%; align-items:end; min-height: 100px;'>
                        <h5 style='margin-bottom: 0 !important;display: inline;'>Naam leerkracht:
                            <?php echo $teacher; ?></h5>
