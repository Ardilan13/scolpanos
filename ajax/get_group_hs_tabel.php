...
<table class="table table-bordered table-colored table-houding">
    ...
    <tbody>
        <?php
        $get_students = "SELECT g.id,g.name,v.volledigenaamvak as vak,v.Klas FROM groups g INNER JOIN le_vakken v ON g.vak = v.ID WHERE g.schoolid = '$schoolid' AND g.schooljaar ='$schooljaar';";
