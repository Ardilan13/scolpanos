...
foreach($array_leerling as $item) {
  ...
  $page_html .="</br>";
  $page_html .="</br>";
  $page_html .="<img  src='".appconfig::GetBaseURL()."/assets/img/Abrahamdeveer.jpeg' class='mx-auto d-block'>";
  ...
  $page_html .="<tbody>";
  $page_html .="<tr>";
  $page_html .="<td width='40%' height='50'><b>Reporta van</b></td>";
  $page_html .="<td >".$item['achternaam']." ".$item['voornamen']."</td>";
  $page_html .="</tr>";
  $page_html .="<tr>";
  $page_html .="<td width='40%' height='50'><b>Klas</b></td>";
  $page_html .="<td>".$item["klas"]."";
  $page_html .="</td>";
  $page_html .="</tr>";
  $page_html .="<tr>";
  $page_html .="<td width='40%' height='50'><b>Cursus jaar</b></td>";
  $page_html .="<td>".$_GET["schoolJaar"]."</td>";
  $page_html .="</tr>";
  $page_html .="</tbody>";
  $page_html .="</table>";
  $page_html .="</div>";
  ...
  $page_html .="<h5 class='card-title text-center'>A B R A H A M&nbsp&nbspD E&nbsp&nbspV E E R&nbsp&nbsp&nbsp&nbsp&nbspC O L L E G E</h5>";
