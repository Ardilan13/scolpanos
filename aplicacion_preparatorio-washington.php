...
<head>
    <title>Scol Preparatorio Washington</title>
...
<main>
    <div class="container">
        <div class="form-bg"'>
            ...
            $query = "SELECT ID,status,fam,nomber,sexo,f_nacemento,districto,ruman,collega,number_mayor1,number_mayor2,prome_preferencia,segundo_preferencia FROM aplicacion_forms WHERE (prome_preferencia=16 OR segundo_preferencia=16) ORDER BY ID ASC";
            ...
            <form action="ajax/get_aplicacionform_excel.php" method="POST">
                ...
                <input name="admin" type="text" value="16" hidden>
