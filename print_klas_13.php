...
foreach($data_leerling_array as $item) {
  ...
  $print_table = $c->list_cijfers_by_student_13($_GET["schoolJaar"],$item['studentid'],appconfig::GetDummy());
...
";
  ...
  $page_html .="<td width='310px' style='text-align: right;'>";

  $page_html .="<img style='text-align: right;' src='".appconfig::GetBaseURL()."/assets/img/Abrahamdeveer.jpeg' width='100px'>";
  ...
  $page_html .="<h1 class='col-md-12 secondary-color'>Commandant Generaal Abraham de Veerschool";
  ...
  $page_html .="<h2 class='col-md-12 primary-color'>Schooljaar: ".$_GET["schoolJaar"]."</h2>";
  $page_html .="<h2 class='col-md-12 primary-color'>Trimester: 1</h2>";
  //$page_html .="<h2 class='col-md-12 primary-color'>Trimester: ".$_GET["schoolJaar"]."</h2>";
