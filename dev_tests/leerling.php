								...
								<div class="sixth-bg-color box content full-inset" id="leerling_new" name="leerling_new">
									<form class="form-horizontal align-left" role="form" name="form-add-student" id="form-addStudent">
										...
										<fieldset>
											...
											<input type="hidden" name="baseurl" id="baseurl" value=<?php require_once("config/app.config.php"); print appconfig::GetBaseURL(); ?> />
						...
						<div class="primary-bg-color brd-full">
							<div class="box">
								...
								<div class="box-content full-inset sixth-bg-color koppenkaart">
									<div class="row">
										<div id="dataRequest-student_pic"></div><!--This section its for the profiles pictures.-->
									</div>
