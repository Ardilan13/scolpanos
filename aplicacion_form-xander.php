...
<head>
    <title>Aplicacion Form Xander</title>
...
<main>
    <div class="container">
        <div class="form-bg"'>
            ...
            $query = "SELECT ID,status,fam,nomber,sexo,f_nacemento,districto,ruman,collega,number_mayor1,number_mayor2,prome_preferencia,segundo_preferencia FROM aplicacion_forms WHERE (prome_preferencia = 8 OR segundo_preferencia = 8) ORDER BY ID ASC";
            ...
            <table class="table table-striped table-bordered">
                ...
                <?php while ($row = mysqli_fetch_assoc($resultado)) { ?>
                    <tr>
                        ...
                        <th><?php if ($row["prome_preferencia"] == 8) {
                                echo '1';
                            } else {
                                echo '2';
                            } ?></th>
                        ...
                        <input name="scol" type="text" hidden value="8">
